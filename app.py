...
# ── Gemini 호출 함수들 ────────────────────────────────────────────────────────
def run_appeal_analysis(model, page_text: str, url: str) -> str:
...
def run_video_plan(model, appeal_result: str) -> str:
...
def run_proposal(model, appeal_result: str, video_plan: str) -> str:
